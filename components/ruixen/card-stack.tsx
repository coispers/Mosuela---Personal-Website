      ...
      >
        ...
        {showArrows && len > 1 && (
          <>
            <button
              onClick={prev}
              className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 z-30 rounded-full bg-background/50 backdrop-blur-sm border border-border/30 p-2 text-foreground/50 hover:text-foreground hover:bg-background/80 opacity-50 hover:opacity-100 transition-all duration-200"
            ...
            <button
              onClick={next}
              className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 z-30 rounded-full bg-background/50 backdrop-blur-sm border border-border/30 p-2 text-foreground/50 hover:text-foreground hover:bg-background/80 opacity-50 hover:opacity-100 transition-all duration-200"
